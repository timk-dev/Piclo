...
const Login = ({setToken, setParentState}) => {
            ...
            <section className={styles.content}>
                <article className={styles.scrollCont}>
                    ...
                    <div className={styles.inputContainer}>
                        <label className={styles.inputLabel} for="email_field">Email</label>
                        ...
                        <input value={getEmail} onInput={(e) => {setGetEmail(e.target.value)}} placeholder="name@mail.com" title="Inpit title" name="input-name" type="text" className={styles.inputField} id="email_field"></input>
                    </div>
                    <div className={styles.inputContainer}>
                        <label className={styles.inputLabel} for="password_field">Password</label>
                        <svg fill="none" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg" className={styles.icon}>
                        ...
                        <input value={getPassword} onInput={(e) => {setGetPassword(e.target.value)}} placeholder="Password" title="Inpit title" name="input-name" type="password" className={styles.inputField} id="password_field"></input>
                    </div>
                    <button title="Sign In" type="submit" className={styles.signInBtn}>
                        <span>Sign In</span>
                    </button>

                    <button title="Sign In" type="submit" className={styles.signInGgl}>
                    ...
                    <button onClick={handleClick} title="Create Account" className={styles.signInApl}>
